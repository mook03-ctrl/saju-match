...
const PERSONALITY_TIPS = {
    "male": {
        "甲": { traits: "순수하고 돌직구이며 계산적이지 않습니다. 정복하려는 힘과 남성 호르몬이 강해 동물적으로 들이대는 경향이 있습니다.", attraction: "섹시하고 참한 이미지, 건강하고 아이를 잘 낳을 것 같은 여성을 선호합니다. 자존심에 상처를 주지 않고 엄마처럼 따뜻하게 품어주는 여성에게 끌립니다." },
        "乙": { traits: "배려심이 깊고 섬세하며 남에게 부담 주기를 싫어합니다. 예민해서 자신을 피곤하게 하거나 구속하면 도망갑니다.", attraction: "의지할 수 있고 편안하며 정신적인 안정감을 주는 휴식처 같은 여성을 좋아합니다. 변덕이 심하거나 질투를 유발하는 행동은 피하고 혼자만의 공간을 존중해 주어야 합니다." },
        "丙": { traits: "예의가 바르고 환하며, 어딜 가나 주목받는 것을 좋아합니다. 눈치는 빠르지만 은근히 백치미와 순진한 매력이 있습니다.", attraction: "외모가 뛰어나거나 특별한 재능/전문직 등 자신만의 확실한 가치가 있는 여성을 좋아합니다. 예의 바르고 어른에게 싹싹한 여자에게 반하며 구속을 싫어합니다." },
        "丁": { traits: "장인 정신이 있고 속에는 용암 같은 열정을 품고 있어 성공하는 사람이 많습니다. 기억력이 매우 좋고 뒤끝이 있으며 밤에 강합니다.", attraction: "여성스럽고 아기자기한 것을 좋아하며 감수성과 예술적 성향을 잘 맞춰주는 밀당 잘하는 여성을 선호합니다. 친구 같으면서도 반드시 여성성이 있어야 호감을 유지합니다." },
        "戊": { traits: "큰 산처럼 변함없이 편안하고 안정감을 줍니다. 한 번 마음먹으면 덤프트럭처럼 밀어붙이는 묵직한 고집과 끈기가 있습니다.", attraction: "의심 없이 자신을 지지해 주고 조용히 응원해 주는 진실한 여성에게 빠집니다. 무토남의 고집을 억지로 바꾸려 해선 안 되지만, 유일하게 '계수(癸)'녀에게는 흔들리고 맞춰주는 경향이 있습니다." },
        "己": { traits: "꼼꼼하고 은근한 리더십이 있으며 자신의 울타리 안에 있는 사람에게는 희생정신과 배려심이 아주 강합니다.", attraction: "해맑고 귀여운 소녀 이미지이면서도 기댈 수 있는 어른스러운 여성(엄마나 장녀 느낌)을 좋아합니다. 자기주장이 너무 세거나 예측 불가능하게 불안하게 만드는 여성은 기피합니다." },
        "庚": { traits: "확실하고 군더더기가 없으며, 시도와 도전을 좋아해 주목받는 스타성이 있습니다.", attraction: "항상 신선하고 깨끗하며 색다른 모습으로 꾸미는 여성에게 호감이 상승합니다. 잔소리보다는 부드럽게 다독여서 자신의 실수를 스스로 깨닫게 해주는 여성에게 약합니다." },
        "辛": { traits: "겉으론 실속을 잘 챙기고 여우 같지만, 생각보다 여리고 정교합니다. 눈치가 빨라 다 알면서도 모르는 척하며 상처를 평생 잊지 않습니다.", attraction: "리더십 있고 생활력이 강하며 앞장서는 전문직 여성을 좋아합니다. 자신의 고민을 해석하고 안심시켜 주며 리드해 줄 수 있는 여성이 잘 맞습니다." },
        "壬": { traits: "다정하게 안아주는 센스남으로, 다방면에 능하고 옷도 잘 입으며 잘 놉니다. 이상형을 만나면 집착이 심해지기도 합니다.", attraction: "눈이 상당히 높은 편이며 외모(몸매 등)가 평균 이상이어야 하며 무엇보다 여성의 능력, 생활력, 전문성을 매우 중요하게 봅니다. 속궁합과 배려가 잘 맞는 친구 같은 이성도 선호합니다." },
        "癸": { traits: "속을 알 수 없지만 다정하고 섬세하게 맞춰주어 '여자들이 잊지 못하는 남자 1위'로 꼽힙니다. 가정적이지만 내 것에 대한 욕심과 계산적인 면도 있습니다.", attraction: "유치원 교사처럼 밝고 모범적인 행동으로 자신을 웃게 해주는 여성을 좋아합니다. 사소한 챙김과 배려에 크게 감동하며 권위적이거나 심부름을 유발하면 오히려 관계가 망가집니다." }
    },
    "female": {
        "甲": { traits: "솔직하고 앞뒤가 다르지 않으며, 은근한 백치미가 있습니다. 독립심이 강하고 자기 일(전문성)을 중요시하며 인내심이 매우 강합니다.", attraction: "하고 싶은 것은 꼭 해야 하므로 옆에서 진지하게 조언해 주면서도 행동을 통제하지 않는 남성을 좋아합니다. 사소한 칭찬에 약하고 배려해 주면 큰 감동을 받습니다." },
        "乙": { traits: "잡초처럼 생활력이 강하고 감정 기복이 심하며, 타인의 감정에 매우 예민하게 반응합니다.", attraction: "동정심(비슷한 상처/아픔)을 자극하면 마음이 약해져 쉽게 넘어갑니다. 나쁜 남자(이성적이기보단 감성적인) 약간의 똘끼/화려함이 있는 순수한 남성에게 끌립니다." },
        "丙": { traits: "성격이 화끈하고 깔끔하며 속을 숨기지 못하는 '메뉴판' 같은 솔직한 성격입니다. 헌신적이고 희생적인 면도 있습니다.", attraction: "조용히 자신을 챙겨주고 다정하며 지적인 남성(예: 여행 가서 짐 챙겨주는 세심한 남자)에게 흠뻑 빠집니다. 자신을 무시하는 발언은 절대 금물입니다." },
        "丁": { traits: "꼼꼼하고 예술적인 끼가 많으며 새초롬한 인상을 줍니다. 혼자 있으면 외로움을 크게 타고 디테일하고 까다로운 편입니다.", attraction: "다정한 '집사' 같은 남성에게 강력하게 끌립니다. 야근할 때 택시를 타고 데리러 오는 등의 현실적이고 세심한 헌신에 크게 감동합니다. 낮보다 밤(비밀 모임)에 매력이 극대화됩니다." },
        "戊": { traits: "포근하고 편안하며 흔들림 없는 묵직함(고급 매트리스 같은 안정감)이 있어 여자들 사이에서도 인기가 많습니다.", attraction: "큰 정원이나 뻥 뚫린 대자연이 보이는 데이트 장소를 좋아합니다. 단순하고 솔직하며 재잘재잘 말하는 아이 같은 순수한 남성에게 호감을 느낍니다." },
        "己": { traits: "레이스 장갑을 낀 일본 귀족처럼 겉은 친절하나 속마음을 잘 드러내지 않습니다. 가족을 위해 자신을 단단하게 희생하는 장녀 스타일입니다.", attraction: "의심이 많으므로 남자에게서 불안감이나 변수를 느끼면 안 됩니다. 옷이나 체형 등 보여지는 겉모습(명예욕)도 중시하므로 남자의 외적인 자기 관리가 필요합니다." },
        "庚": { traits: "쿨하고 시원시원하며 모든 것을 해결해 줄 것 같은 K-장녀 스타일입니다. 호불호가 극명하고 진보적 독심이 큽니다.", attraction: "같이 꽁냥꽁냥할 수 있는 친구 같은 남성을 좋아하며 정금녀의 기를 살려주고 인정해 주는 남성(정화남 등)과 잘 맞습니다. 여성이 일을 하지 못하게 만들면 우울해하므로 활동을 지지해 주어야 합니다." },
        "辛": { traits: "자신을 '보석'으로 여기며 항상 예쁘다, 귀엽다 존중받기를 원합니다. 완벽주의 성향과 안테나 같은 예민한 신기(감각)를 가졌습니다.", attraction: "연하남은 감당하기 어려워하고, 자신을 무조건 예뻐해 주는 나이 차이가 많은 연상남이나 묵묵히 받아주는 오빠 같은 임수(壬)남에게 끌림을 느낍니다." },
        "壬": { traits: "우아하고 품격이 있으며, 생각이 깊고 속을 알 수 없는 묘한 분위기(노을 지는 바다)가 있습니다.", attraction: "호들갑 떠는 가벼운 남자보다는 철학이 있고 인생에 대해 진지하게 생각하는 지혜로운 남성을 선호합니다. 특히 노래와 가사를 통한 감성적인 어필(음악 선물 등)에 약합니다." },
        "癸": { traits: "여름비 내린 가로등 아래 우산 쓴 여자처럼 묘한 분위기를 풍기며 눈물과 마음이 약하지만 승부욕이 강합니다.", attraction: "나이 차이가 많이 나거나 능력/재력이 탁월한 남성에게 강하게 끌립니다. 자신을 웃게 해주는 담백한 남성이 좋으며, 남자가 매력적으로 자기 계발을 하고 있으면 알아서 곁에 남습니다." }
    }
};
...
function renderResult(name, sajuResult, analysis, imgSrc, filter, gender) {
    ...
    const pTips = PERSONALITY_TIPS[gender] && PERSONALITY_TIPS[gender][sajuResult.palja.dS];
    if (pTips) {
        document.getElementById('personality-analysis').innerHTML = `
